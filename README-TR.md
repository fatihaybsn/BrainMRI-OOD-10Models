<p align="right"><a href="README.md">🇬🇧 English</a> | 🇹🇷 Türkçe</p>

# Brain MRI Tumor vs No-Tumor — OOD Genelleme (10 Model)
...
## 🌐 Portföy Proje Sayfası

Projenin daha görsel ve ayrıntılı anlatımı, mimari karşılaştırmaları ve öne çıkan sonuçları için portföy sitemdeki proje sayfasını ziyaret edin:

> **[BrainMRI OOD — 10 Model Proje Sayfasını Görüntüle](https://fathaybasn.me/projects/brainmri-ood-10models)**
